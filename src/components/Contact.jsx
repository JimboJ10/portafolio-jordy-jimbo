    ...
    <section id="contacto" className="py-20 sm:py-28">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-5 lg:gap-6 mb-10 animate-on-scroll">
            {contactItems.map((item) => (
              <a
                ...
                className="focus-ring group surface-panel min-h-44 p-6 rounded-lg hover:border-border-hover transition-all duration-300 text-center flex flex-col items-center justify-center"
              >
